...
def lowprice_hotels(city_id, user):
    """
         1) current  = цена
         2) name = Название
    ...
    querystring = {"destinationId": city_id, "pageSize": user.hotels, "sortOrder": "PRICE", "locale": "en_US",
